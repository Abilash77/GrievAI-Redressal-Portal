...
- [requirements.md](requirements.md) : Detailed problem statement, USP, and core features  
...
3. Run the app: npm run dev , give this also maekdown format dont canhange any thing
